...
if __name__ == "__main__":
	...
	auc_cv, auc_thresh_cv,_,_,_,_,_,_ = resample_test(df_scw[pd.DatetimeIndex(df_scw.dt_utc).year>=2019], 
		 ...
		 df_null1, 
		 df_null2, 
		 df_null3, "AUC", N, test_vars, n_samples)
	...
	auc.to_csv("/g/data/eg3/ab4502/ExtremeWind/skill_scores/auc_era5_clusterall_in10km_test.csv",index=False)
	auc1.to_csv("/g/data/eg3/ab4502/ExtremeWind/skill_scores/auc_era5_cluster1_in10km_test.csv",index=False)
	auc2.to_csv("/g/data/eg3/ab4502/ExtremeWind/skill_scores/auc_era5_cluster2_in10km_test.csv",index=False)
	auc3.to_csv("/g/data/eg3/ab4502/ExtremeWind/skill_scores/auc_era5_cluster3_in10k_testm.csv",index=False)
	auc_cv.to_csv("/g/data/eg3/ab4502/ExtremeWind/skill_scores/auc_era5_clusterall_cv_in10k_testm.csv",index=False)
	auc_full.to_csv("/g/data/eg3/ab4502/ExtremeWind/skill_scores/auc_full_era5_clusterall_in10k_testm.csv",index=True)
	auc_full1.to_csv("/g/data/eg3/ab4502/ExtremeWind/skill_scores/auc_full_era5_cluster1_in10k_testm.csv",index=True)
	auc_full2.to_csv("/g/data/eg3/ab4502/ExtremeWind/skill_scores/auc_full_era5_cluster2_in10k_testm.csv",index=True)
	auc_full3.to_csv("/g/data/eg3/ab4502/ExtremeWind/skill_scores/auc_full_era5_cluster3_in10k_testm.csv",index=True)
	auc_full_cv.to_csv("/g/data/eg3/ab4502/ExtremeWind/skill_scores/auc_full_era5_clusterall_cv_in10km_test.csv",index=True)
